<template>
  <section>
    ...
    <el-table :data="tableData.list"
      ...
      <el-table-column prop="name" label="资源名" width="120"></el-table-column>
      <el-table-column prop="type" label="资源类型" width="120"></el-table-column>
      <el-table-column prop="resource" label="资源URL/地址" width="120"></el-table-column>
      <el-table-column prop="authorities" label="权限"></el-table-column>
