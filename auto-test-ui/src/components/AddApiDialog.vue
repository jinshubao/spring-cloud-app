<template>
    <el-dialog title="新增接口" v-model="dialogOpenFlag" :close-on-click-modal="false">
        <el-form :model="formData" label-width="80px" :rules="formRules" ref="formData">
            <el-form-item label="模块" prop="projectModule">
                <el-cascader :options="projectNames" v-model="formData.projectModule">
                </el-cascader>
            </el-form-item>
            ...
            <el-form-item label="协议" prop="protocol">
                <el-select v-model="formData.protocol" placeholder="请选择">
                    <el-option v-for="item in protocols" :key="item" :index="item" :label="item" :value="item"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="方法" prop="method">
                <el-select v-model="formData.method" placeholder="请选择">
                    <el-option v-for="item in methods" :key="item"  :index="item" :label="item" :value="item"></el-option>
                </el-select>
            </el-form-item>
